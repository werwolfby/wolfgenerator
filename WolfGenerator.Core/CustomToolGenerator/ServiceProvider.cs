...
namespace CustomToolGenerator
{
	...
	public class ServiceProvider : IServiceProvider, IObjectWithSite
	{
		...
		public virtual object GetService( Type serviceClass )
		{
			...
			return this.GetService( serviceClass.GUID, serviceClass );
		}
		...
		{
			return this.GetService( guid, null );
		}
		...
		private object GetService( Guid guid, Type serviceClass )
		{
			...
			//
			if (this.serviceProvider == null) return null;
			...
			//
			if (guid.Equals( typeof(IOleServiceProvider).GUID )) return this.serviceProvider;
			if (guid.Equals( typeof(IObjectWithSite).GUID )) return (IObjectWithSite)this;

			IntPtr pUnk;
			var hr = this.serviceProvider.QueryService( ref guid, ref IID_IUnknown, out pUnk );
		...
		{
			if (pUnkSite is IOleServiceProvider) this.serviceProvider = (IOleServiceProvider)pUnkSite;
		}
